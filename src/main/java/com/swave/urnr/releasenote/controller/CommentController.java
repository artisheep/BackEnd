...
public class CommentController {
    ...
    @PostMapping("/api/project/{projectId}/release-note/{releaseNoteId}/comment")
    ...
    @GetMapping("/api/project/{projectId}/release-note/{releaseNoteId}/recent-comments")
    ...
    @DeleteMapping("/api/project/{projectId}/release-note/{releaseNoteId}/comment/{commentId}")
