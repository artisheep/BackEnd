...
public class ReleaseNoteController {
    private final ReleaseNoteServiceImpl releaseNoteService;
    ...
    @PatchMapping("/api/project/release/update")
    public HttpResponse UpdateReleaseNote(HttpServletRequest request, @RequestBody ReleaseNoteUpdateRequestDTO releaseNoteUpdateRequestDTO) {
        return releaseNoteService.updateReleaseNote(request, releaseNoteUpdateRequestDTO);
    }
    ...
    @GetMapping("/api/project/release/load_recent")
